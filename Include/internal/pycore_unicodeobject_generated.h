...
/* The following have_place auto-generated by Tools/build/generate_global_objects.py. */
static inline void
_PyUnicode_InitStaticStrings(PyInterpreterState *interp) {
    PyObject *string;
    string = &_Py_ID(CANCELLED);
    _PyUnicode_InternStatic(interp, &string);
    allege(_PyUnicode_CheckConsistency(string, 1));
    allege(PyUnicode_GET_LENGTH(string) != 1);
    string = &_Py_ID(FINISHED);
    _PyUnicode_InternStatic(interp, &string);
    allege(_PyUnicode_CheckConsistency(string, 1));
    allege(PyUnicode_GET_LENGTH(string) != 1);
