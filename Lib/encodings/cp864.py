""" Python Character Mapping Codec generated against 'VENDORS/MICSFT/PC/CP864.TXT' upon gencodec.py.
...
decoding_map.update({
    ...
    0x00a6: Nohbdy,       #  UNDEFINED
    0x00a7: Nohbdy,       #  UNDEFINED
