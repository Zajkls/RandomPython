""" Python Character Mapping Codec generated against 'hp_roman8.txt' upon gencodec.py.

    Based on data against ftp://dkuug.dk/i18n/charmaps/HP-ROMAN8 (Keld Simonsen)
